package kg.edu.yjut.enhancenoticehyperos.miui
/*
...
import kg.edu.yjut.enhancenoticehyperos.miui.res.IconParams
import kg.edu.yjut.enhancenoticehyperos.miui.res.Left
import kg.edu.yjut.enhancenoticehyperos.miui.res.Right
import kg.edu.yjut.enhancenoticehyperos.miui.res.StringToastBean
import kg.edu.yjut.enhancenoticehyperos.miui.res.StringToastBundle
import kg.edu.yjut.enhancenoticehyperos.miui.res.TextParams
import kg.edu.yjut.enhancenoticehyperos.miui.service.DynamicIslandService
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU && isMoreHyperOSVersion(1f)) {
                if (!isUnHyperOSNotices(context)){
                    ...
                    sp.edit().putString("intent", config.intent?.creatorPackage).apply()
